 ...
 * Componente de tabla para mostrar registros dentales
 * Usa CSS Grid para el layout
 */
class DentalRecordsTable extends HTMLElement {
    constructor() {
        super();
    ...
    updateRows() {
        ...
        this.items.forEach((item, index) => {
            const row = document.createElement('dental-records-row');
        ...
        if (this.items.length === 0) {
            ...
            emptyRow.textContent = 'No hay registros dentales';
    ...
    render() {
        ...
        template.innerHTML = `
            ...
            <div class="dental-records-table">
                <div class="table-header">
                    ...
                    <div class="header-cell">Diagnóstico</div>
...
customElements.define('dental-records-table', DentalRecordsTable);
