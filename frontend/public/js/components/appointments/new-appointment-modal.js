...
class NewAppointmentModal extends HTMLElement {
    ...
    async handleSubmit() {
        ...
        const duration_minutes = parseInt(formData.get('duration')) || 15; // Duración predeterminada a 15 minutos
        const precio_cita = parseFloat(formData.get('precio_cita')) || 400; // Precio predeterminado a $400
        ...
        try {
            ...
            const appointmentData = {
                ...
                status: 'scheduled', // Estado predeterminado en 'scheduled'
                notes: notes || '',
                duration_minutes: duration_minutes,
                precio_cita: precio_cita, // Añadir el precio de la cita
                patient_info: {
                    id: patient.id,
